...
function mdDocumentation() {
    ...
    function loadJsonFile(name) {
        ...
        if (fs$1.existsSync(datafile)) {
            const parsed = JSON.parse(fs$1.readFileSync(datafile, "utf-8"));
            return parsed;
        }
        return false;
    }
    ...
    function loadMdFile() {
        ...
        if (fs$1.existsSync(datafile)) {
            const parsed = fs$1.readFileSync(datafile, "utf-8");
            return parsed;
        }
    }
    ...
    function saveMdFile(data) {
        const datafile = path.join(process.cwd(), mdfilename);
        if (fs$1.existsSync(datafile)) {
            fs$1.writeFileSync(datafile, data, "utf-8");
        }
    }
    ...
    function saveJsonFile(data, componentEntry, outputapifilename) {
        ...
        fs$1.writeFileSync(datafile, JSON.stringify(data, null, 2), "utf-8");
        //}
    }
...
export { mdDocumentation as default };
